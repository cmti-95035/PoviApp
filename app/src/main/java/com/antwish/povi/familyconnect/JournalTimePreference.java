 ...
 */
public class JournalTimePreference extends DialogPreference {
    private TimePicker timePicker;
    private Context context;
    private String key;
    private static final String AM = "AM";
    private static final String PM = "PM";
    public JournalTimePreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        setPersistent(false);
    ...
    public View onCreateDialogView(){
        ...
        Date date = new Date(settings.getLong("journal_time",0));
    ...
    protected void onDialogClosed(boolean positiveResult){
        ...
        if(positiveResult){
           Calendar cal = Calendar.getInstance();
            ...
            editor.putLong("journal_time", cal.getTime().getTime());
            editor.commit();
